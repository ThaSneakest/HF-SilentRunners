...
'and with 32 & 64-bit versions of XP/Server 2003/Vista/7/8/10/11/Server 2008) 
'
'DO NOT REMOVE THIS HEADER!
'
'Copyright Andrew ARONOFF 22 November 2023, http://www.silentrunners.org/
...
For Each oOS in colOS
 ...
 End If
 If InStr(strOSLong,"Windows 11") > 0 Or _
  InStr(strOSLong,"Windows" & Chr(160) & "11") > 0 Then
   strOS = "WN7" : strOSSS = "W11"
 End If
...
arAllowedCLSID(30,0) = "{578480AA-1B1C-4343-AABD-62C0A273DCB5}" : arAllowedCLSID(30,1) = "Windows.CloudStore.dll" 
arAllowedCLSID(31,0) = "{78DE489B-7931-4f14-83B4-C56D38AC9FFA}" : arAllowedCLSID(31,1) = "Windows.FileExplorer.Common.dll" 

'arAllowedCLSID(32,0) = "" : arAllowedCLSID(32,1) = "" 
...
arSEA(431,0) = "{09A47860-11B0-4DA5-AFA5-26D86198A780}" : arSEA(431,1) = "shellext.dll" 
...
If strOS = "WVA" Or strOS = "WN7" Then
 ...
 arAllowedCLSID(1,32,0) = "{C5D7540A-CD51-453B-B22B-05305BA03F07}" : arAllowedCLSID(1,32,1) = "cxcredprov.dll" 
 arAllowedCLSID(1,33,0) = "{F8A1793B-7873-4046-B2A7-1F318747F427}" : arAllowedCLSID(1,33,1) = "fidocredprov.dll" 
 arAllowedCLSID(1,34,0) = "{f64945df-4fa9-4068-a2fb-61af319edd33}" : arAllowedCLSID(1,34,1) = "rdpcredentialprovider.dll" 
...
'applies to W2K/WXP/WVA/WN7/WN8/W10/W11
...
If Not flagTest Or (flagTest And SecTest) Then
 ...
 arAllowedCLSID(61,0) = "{CFF649BD-601D-4361-AD3D-0FC365DB4DB7}" : arAllowedCLSID(61,1) = "domgmt.dll" 
 arAllowedCLSID(62,0) = "{8472C2C4-6B70-4301-A20D-A6CEA5F82B7E}" : arAllowedCLSID(62,1) = "starttiledata.dll" 

'arAllowedCLSID(63,0) = "" : arAllowedCLSID(63,1) = "" 
  ...
  If IsArray(arSubKeys) Then
   ...
   For Each strSubKey in arSubKeys
    ...
    If intErrNum = 0 And strValue <> "" Then
     ...
     'test for two allowed name/value pairs
     'skip CoName -- for "ntsd -d" added by debugging tools
     'skip two allowed sub-keys unless ShowAll
     If (LCase(strSubKey) = LCase("Your Image File Name Here without a path") And _
      LCase(Trim(strValue)) = "ntsd -d") Or _
      (LCase(strSubKey) = "compattelrunner.exe" And InStr(LCase(strValue),"taskkill.exe") > 0 And _
      CoName(IDExe(strValue)) = MS) Then 
     ...
     Else  'not one of two allowed name/value pairs
...
ElseIf strOS = "WVA" Or strOS = "WN7" Then  'WVA, WN7, WS2K8 R2, WN8, W10, W11 

  ReDim arMSSvc(184,2)  'WN7 & WS2K8 R2
  If strOS   = "WVA" Then ReDim arMSSvc(193,2)
  If strOSSS = "WN8" Then ReDim arMSSvc(187,2)
  If strOSSS = "W10" Or strOSSS = "W11" Then ReDim arMSSvc(227,2)
  ...
  If strOSSS = "WN8" Or strOSSS = "W10" Or strOSSS = "W11" Then arMSSvc(21,2) = "netprofmsvc.dll" 
  ...
  If strOSSS = "WN8" Or strOSSS = "W10" Or strOSSS = "W11" Then arMSSvc(47,2) = "AudioEndpointBuilder.dll" 
  arMSSvc(48,0) = "WinDefend" : arMSSvc(48,1) = "svchost.exe" : arMSSvc(48,2) = "mpsvc.dll" 
  If strOSSS = "WN8" Or strOSSS = "W10" Or strOSSS = "W11" Then
  ...
  If strOSSS = "W10" Or strOSSS = "W11" Then arMSSvc(146,2) = "psmsrv.dll"
  ...
  If strOSSS = "W10" Or strOSSS = "W11" Then
   ...
   arMSSvc(200,0) = "usosvc" : arMSSvc(200,1) = "svchost.exe" : arMSSvc(200,2) = "usosvc.dll"
   ...
   arMSSvc(216,0) = "InstallService" : arMSSvc(216,1) = "svchost.exe" : arMSSvc(216,2) = "InstallService.dll"
   arMSSvc(217,0) = "camsvc" : arMSSvc(217,1) = "svchost.exe" : arMSSvc(217,2) = "CapabilityAccessManager.dll"
   arMSSvc(218,0) = "SgrmBroker" : arMSSvc(218,1) = "SgrmBroker.exe" : arMSSvc(218,2) = ""
   arMSSvc(219,0) = "BTAGService" : arMSSvc(219,1) = "svchost.exe" : arMSSvc(219,2) = "BTAGService.dll"
   arMSSvc(220,0) = "BthAvctpSvc" : arMSSvc(220,1) = "svchost.exe" : arMSSvc(220,2) = "BthAvctpSvc.dll"
   arMSSvc(221,0) = "DispBrokerDesktopSvc" : arMSSvc(221,1) = "svchost.exe" : arMSSvc(221,2) = "DispBroker.Desktop.dll"
   arMSSvc(222,0) = "DisplayEnhancementService" : arMSSvc(222,1) = "svchost.exe" : arMSSvc(222,2) = "Microsoft.Graphics.Display.DisplayEnhancementService.dll"
   arMSSvc(223,0) = "ScDeviceEnum" : arMSSvc(223,1) = "svchost.exe" : arMSSvc(223,2) = "ScDeviceEnum.dll"
   arMSSvc(224,0) = "WaaSMedicSvc" : arMSSvc(224,1) = "svchost.exe" : arMSSvc(224,2) = "WaaSMedicSvc.dll"
   arMSSvc(225,0) = "XblAuthManager" : arMSSvc(225,1) = "svchost.exe" : arMSSvc(225,2) = "XblAuthManager.dll"
   arMSSvc(226,0) = "TextInputManagementService" : arMSSvc(226,1) = "svchost.exe" : arMSSvc(226,2) = "tabsvc.dll"
   arMSSvc(227,0) = "webthreatdefsvc" : arMSSvc(227,1) = "svchost.exe" : arMSSvc(227,2) = "webthreatdefsvc.dll"

  End If

'   arMSSvc(228,0) = "" : arMSSvc(228,1) = "svchost.exe" : arMSSvc(228,2) = ".dll"
...
'WXP
 ...
 arSBMin(87) = "KeyIso"  'Service d'isolation de cl̩ CNG (.DLL) 
...
'W10
 ...
 arSBMin(159) = "AudioEndpointBuilder"
 arSBMin(160) = "Audiosrv"
 arSBMin(161) = "CBDHSvc"
 arSBMin(162) = "HdAudAddService.sys"
 arSBMin(163) = "HdAudBus.sys"
 arSBMin(164) = "SerCx2.sys"
 arSBMin(165) = "usbaudio.sys"
 arSBMin(166) = "{4D36E96C-E325-11CE-BFC1-08002BE10318}"  'Media
 arSBMin(167) = "{F2E7DD72-6468-4E36-B6F1-6488F42C1B52}"  'Firmware
 arSBMin(168) = "NetSetupSvc"
 arSBMin(169) = "WinQuic"
...
ElseIf strOS = "WVA" Or strOS = "WN7" Then
 ...
 If strOSSS = "W10" Then arPMon(4,1) = "APMon.dll"
 arPMon(5,0) = "LPR Port" : arPMon(5,1) = "lprmon.dll"
 arPMon(6,0) = "Appmon" : arPMon(6,1) = "AppMon.dll"
 arPMon(7,0) = "PJL Language Monitor" : arPMon(7,1) = "PJLMON.DLL"
...
'R73 (W10 v1909 November 2019 Update)
'section  5: added 1 arAllowedCLSID for ShellServiceObjects
'section  6: added 1 arSEA for Shell Extensions\Approved\
'section 10: added 2 arAllowedCLSID for Credential Providers
'section 12: added 1 arAllowedCLSID for Winlogon\GPExtensions
'section 32: added 6 services (BrokerInfrastructure & UsoSvc .DLLs were RENAMED!) 
'section 33: added 10 arSBMin for Safe Mode drivers and services
'section 36: added 1 arPMon for Print Monitors

'R74 (W10 v2004 May 2020 Update)
'section  5: added 1 arAllowedCSID for ShellServiceObjects
'section 13: added 1 subkey for Image File Execution Options
'section 32: added 2 services

'R75 (W11 22H2)
'section 10: added 1 arAllowedCLSID for Credential Providers
'section 12: added 1 arAllowedCLSID for Winlogon\GPExtensions
'section 32: added 2 services
